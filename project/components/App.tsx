...
function App() {
  ...
  const handleFormSuccess = () => {
    ...
    if (formIntent === 'download') {
      ...
      link.href = '/CMA_USA_Brochure.pdf';
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-[#00528a] to-[#45afe3] flex items-center justify-center p-4">
        <div className="max-w-2xl w-full bg-white rounded-2xl shadow-2xl p-8 md:p-12 text-center">
          ...
          <button onClick={() => setShowThankYou(false)} className="mt-6 text-[#45afe3] hover:text-[#00528a] font-semibold">
            ← Back to Homepage
          </button>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-stretch">
            ...
            <div className="pb-2 md:pb-4">
              <h2 className="text-3xl md:text-5xl font-extrabold text-[#00528a] mb-6">What is CMA USA?</h2>
              ...
              <p className="text-lg text-gray-700 leading-relaxed mb-4">
                With over 100,000 certified professionals across 140+ countries, CMA USA opens doors to international
            ...
            <div className="overflow-x-auto pb-4 scrollbar-hide">
              <div className="flex gap-6 md:gap-8 px-2" style={{ width: 'max-content' }}>
                ...
                <div className="bg-white/10 backdrop-blur-sm p-6 rounded-2xl border border-white/20 flex-shrink-0" style={{ width: '300px' }}>
                  ...
                  <p className="text-gray-100">Recognized in 140+ countries with 100,000+ certified professionals worldwide</p>
                </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="bg-gray-50 p-8 md:p-12 rounded-2xl shadow-lg">
            ...
            <div className="grid grid-cols-3 md:grid-cols-6 gap-6 md:gap-8 items-center justify-items-center mb-6">
              <img src="https://logo.clearbit.com/pwc.com" alt="PwC" className="h-10 w-auto grayscale hover:grayscale-0 transition" onError={(e) => { (e.currentTarget as HTMLImageElement).style.display = 'none'; }} />
              <img src="https://logo.clearbit.com/deloitte.com" alt="Deloitte" className="h-10 w-auto grayscale hover:grayscale-0 transition" onError={(e) => { (e.currentTarget as HTMLImageElement).style.display = 'none'; }} />
              <img src="https://logo.clearbit.com/ey.com" alt="EY" className="h-10 w-auto grayscale hover:grayscale-0 transition" onError={(e) => { (e.currentTarget as HTMLImageElement).style.display = 'none'; }} />
              <img src="https://logo.clearbit.com/kpmg.com" alt="KPMG" className="h-10 w-auto grayscale hover:grayscale-0 transition" onError={(e) => { (e.currentTarget as HTMLImageElement).style.display = 'none'; }} />
              <img src="https://logo.clearbit.com/mckinsey.com" alt="McKinsey" className="h-10 w-auto grayscale hover:grayscale-0 transition" onError={(e) => { (e.currentTarget as HTMLImageElement).style.display = 'none'; }} />
              <img src="https://logo.clearbit.com/bcg.com" alt="BCG" className="h-10 w-auto grayscale hover:grayscale-0 transition" onError={(e) => { (e.currentTarget as HTMLImageElement).style.display = 'none'; }} />
              <img src="https://logo.clearbit.com/amazon.com" alt="Amazon" className="h-10 w-auto grayscale hover:grayscale-0 transition" onError={(e) => { (e.currentTarget as HTMLImageElement).style.display = 'none'; }} />
              <img src="/images/IBM.webp" alt="IBM" className="h-10 w-auto grayscale hover:grayscale-0 transition" onError={(e) => { (e.currentTarget as HTMLImageElement).style.display = 'none'; }} />
              <img src="https://logo.clearbit.com/goldmansachs.com" alt="Goldman Sachs" className="h-10 w-auto grayscale hover:grayscale-0 transition" onError={(e) => { (e.currentTarget as HTMLImageElement).style.display = 'none'; }} />
              <img src="https://logo.clearbit.com/jpmorgan.com" alt="JP Morgan" className="h-10 w-auto grayscale hover:grayscale-0 transition" onError={(e) => { (e.currentTarget as HTMLImageElement).style.display = 'none'; }} />
              <img src="https://logo.clearbit.com/infosys.com" alt="Infosys" className="h-10 w-auto grayscale hover:grayscale-0 transition" onError={(e) => { (e.currentTarget as HTMLImageElement).style.display = 'none'; }} />
              <img src="https://logo.clearbit.com/accenture.com" alt="Accenture" className="h-10 w-auto grayscale hover:grayscale-0 transition" onError={(e) => { (e.currentTarget as HTMLImageElement).style.display = 'none'; }} />
              <img src="https://logo.clearbit.com/wipro.com" alt="Wipro" className="h-10 w-auto grayscale hover:grayscale-0 transition" onError={(e) => { (e.currentTarget as HTMLImageElement).style.display = 'none'; }} />
              <img src="https://logo.clearbit.com/tcs.com" alt="TCS" className="h-10 w-auto grayscale hover:grayscale-0 transition" onError={(e) => { (e.currentTarget as HTMLImageElement).style.display = 'none'; }} />
              <img src="https://logo.clearbit.com/hsbc.com" alt="HSBC" className="h-10 w-auto grayscale hover:grayscale-0 transition" onError={(e) => { (e.currentTarget as HTMLImageElement).style.display = 'none'; }} />
              <img src="https://logo.clearbit.com/citi.com" alt="Citibank" className="h-10 w-auto grayscale hover:grayscale-0 transition" onError={(e) => { (e.currentTarget as HTMLImageElement).style.display = 'none'; }} />
              <img src="https://logo.clearbit.com/barclays.com" alt="Barclays" className="h-10 w-auto grayscale hover:grayscale-0 transition" onError={(e) => { (e.currentTarget as HTMLImageElement).style.display = 'none'; }} />
              <img src="https://logo.clearbit.com/reliance.com" alt="Reliance" className="h-10 w-auto grayscale hover:grayscale-0 transition" onError={(e) => { (e.currentTarget as HTMLImageElement).style.display = 'none'; }} />
            </div>
          </div>
        </div>
      </section>
